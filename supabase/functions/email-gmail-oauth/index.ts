 ...
 * The Gmail integration system is being replaced with a new inbox system using @n.agentamara.com addresses.
 *
 * Migration Guide:
...
// CORS handler (copied from calendar-oauth)
...
const GOOGLE_GMAIL_REDIRECT_URI =
