-- Update the user notification function to use app_settings
...
-- Update the subscription notification function to use app_settings
...
COMMENT ON FUNCTION public.handle_user_notification IS 'Sends Slack notifications when users are created or updated, using settings from app_settings table';
COMMENT ON FUNCTION public.handle_subscription_notification IS 'Sends Slack notifications when new subscriptions are created, using settings from app_settings table'; 