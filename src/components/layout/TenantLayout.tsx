...
const TenantLayout: React.FC = () => {
  ...
  const navItems = [
    ...
    { to: '/tenant/documents', icon: <FileText size={20} />, label: 'Documents' },
    { to: '/tenant/screening', icon: <CheckSquare size={20} />, label: 'Screening' },
    { to: '/tenant/appointments', icon: <Calendar size={20} />, label: 'Appointments' },
  ];
