...
const TenantDashboard: React.FC = () => {
  ...
  }, [user, fetchProfile, fetchDocuments, fetchScreeningReport, fetchAppointments]);
  ...
  return (
    <div>
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-gray-900">Welcome, {profile?.first_name || 'Tenant'}</h1>
        <p className="text-gray-600 mt-1">Manage your rental application process</p>
      </div>
            ...
            {screeningReport ? (
              <div className="mb-4">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="font-medium">{screeningReport.credit_score}</span>
                </div>
              </div>
            ) : (
              <p className="text-gray-600 mb-4">No screening report available</p>
            )}
