...
const DocumentUpload: React.FC = () => {
  ...
  const { documents, fetchDocuments, uploadDocument, isLoading } = useTenantStore();
  
  const [file, setFile] = useState<File | null>(null);
  const [documentType, setDocumentType] = useState<'id' | 'bank_statement' | 'payslip' | 'other'>('id');
  ...
  return (
    <div>
      <div className="mb-6">
        ...
        <p className="text-gray-600 mt-1">Upload and process your documents for verification</p>
      </div>
              ...
              <div className="mt-4 p-4 bg-gray-50 rounded-lg">
                ...
                <div className="mt-4">
                  <Select
                    ...
                    value={documentType}
                    onChange={(value) => setDocumentType(value as any)}
                    fullWidth
                  />
                </div>
                  ...
                  {!ocrText && !isProcessing ? (
                    ...
                    <div>
                      <div className="flex items-center justify-between mb-2">
                        ...
                        <span className="text-sm font-medium text-blue-600">{ocrProgress}%</span>
                      </div>
          ...
          <CardContent>
            {isProcessing ? (
              ...
              <div className="flex flex-col items-center justify-center h-64 text-center">
                ...
                <p className="text-gray-500">Upload and process a document to see the extracted text here</p>
              </div>
            )}
          </CardContent>
        </Card>
